...
namespace Laser.Bootstrap {
    public static class ThemeHelper {
        ...
        public static dynamic SettingsEval(this WorkContext workContext, string itemName) {
            ...
            if (context.Items[itemName] != null && (string)context.Items[itemName] == bool.TrueString) {
                returnValue = true;
            } else if (context.Items[itemName] != null) {
                returnValue = (string)context.Items[itemName];
            }
            return returnValue;
        }
