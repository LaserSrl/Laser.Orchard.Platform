...
namespace Laser.Specs.Hosting {
    public static class RequestExtensions {
        ...
        public static RequestDetails PostRequest(
            this WebHost webHost, string urlPath, IDictionary<string, IEnumerable<string>> postData = null) {

            return webHost.SendRequest(urlPath, postData, "POST");
        }
