using Laser.Orchard.Queries.Settings;
using Orchard;
...
namespace Laser.Orchard.Queries { //Orchard.Projections.Controllers
    ...
    public class FilterController : Controller {
        ...
        public ActionResult AddGroup(int id) {
            if (!Services.Authorizer.Authorize(TestPermission, T("Not authorized to manage queries")))
                return new HttpUnauthorizedResult();
            ...
            return RedirectToAction("Edit", "UserQueryAdmin", new { query.ContentItemRecord.Id });
        }
        ...
        public ActionResult DeleteGroup(int id) {
            ...
            return RedirectToAction("Edit", "UserQueryAdmin", new { id = queryId });
        }
        ...
        public ActionResult Delete(int id, int filterId) {
            ...
            return RedirectToAction("Edit", "UserQueryAdmin", new { id });
        }
        ...
        public ActionResult EditPost(int id, string category, string type, [DefaultValue(-1)] int filterId, FormCollection formCollection) {
            ...
            if (ModelState.IsValid) {
                ...
                return RedirectToAction("Edit", "UserQueryAdmin", new { group.QueryPartRecord.Id });
            }
