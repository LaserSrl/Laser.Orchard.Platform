...
//          INavigationCacheService cacheService) {
...
//                var cacheKey = _cacheService.GetMenuCacheKey(part.MenuContentItemId);
//                var menuItems = _cacheService.GetCachedMenuItems(menu, cacheKey);
//                menuItems = _cacheService.TryGetRouteValues(menuItems);
