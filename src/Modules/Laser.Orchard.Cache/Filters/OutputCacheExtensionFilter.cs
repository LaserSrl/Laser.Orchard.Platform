...
namespace Laser.Orchard.Cache.Filters {
    [OrchardSuppressDependency("Orchard.OutputCache.Filters.OutputCacheFilter")]
    public class OutputCacheExtensionFilter : OutputCacheFilter, IActionFilter, IResultFilter, IDisposable {
