...
namespace Laser.Orchard.SecureData.Security {
    public class EncryptedStringFieldAuthorizationEventHandler : IAuthorizationServiceEventHandler {
        private readonly ISecureFieldService _secureFieldService;

        public EncryptedStringFieldAuthorizationEventHandler(ISecureFieldService secureFieldService) {
