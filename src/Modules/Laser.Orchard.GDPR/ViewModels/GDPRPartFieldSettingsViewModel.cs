...
namespace Laser.Orchard.GDPR.ViewModels {
    public class GDPRPartFieldSettingsViewModel {

        public GDPRPartFieldSettingsViewModel() {
            Settings = new GDPRPartFieldSettings();
        }

        public GDPRPartFieldSettings Settings { get; set; }
