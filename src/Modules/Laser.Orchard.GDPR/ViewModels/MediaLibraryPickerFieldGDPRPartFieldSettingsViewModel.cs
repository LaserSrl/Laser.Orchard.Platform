...
namespace Laser.Orchard.GDPR.ViewModels {
    ...
    public class MediaLibraryPickerFieldGDPRPartFieldSettingsViewModel {

        public MediaLibraryPickerFieldGDPRPartFieldSettingsViewModel() {
            Settings = new MediaLibraryPickerFieldGDPRPartFieldSettings();
        }

        public MediaLibraryPickerFieldGDPRPartFieldSettings Settings { get; set; }
