...
namespace Contrib.Widgets {
    public class ResourceManifest : IResourceManifestProvider {
        public void BuildManifests(ResourceManifestBuilder builder) {
            ...
            manifest.DefineStyle("TheAdminWidgetContainerStyle").SetUrl("admin.widgets-container.min.css", "admin.widgets-container.css").SetVersion("1.2");
           ...
           // manifest.DefineScript("ThemeAdminAdminJs").SetUrl("~/Themes/TheAdmin/scripts/admin.js");
            ...
            manifest.DefineScript("AdminEditWidget").SetUrl("admin.edit-widget.min.js", "admin.edit-widget.js").SetVersion("1.1");
