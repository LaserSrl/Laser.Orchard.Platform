...
namespace Laser.Orchard.StartupConfig.Security.Providers {
    /// <summary>
    /// Base implementation for providers that generate the UserData for Authentication Bearer Tokens.
    /// To use this, inherit from this abstract class calling the ctor(bool) as follows:
    /// 
    /// public class MyImplementation : BaseBearerTokenDataProvider {
    ...
    public abstract class BaseBearerTokenDataProvider : IBearerTokenDataProvider {

        public BaseBearerTokenDataProvider(bool defaultValid) {
        ...
        /// authentication tokens will be invalidated, because their UserData dictionary does
