...
namespace Laser.Orchard.StartupConfig.Settings {
    public class FrontendEditorConfigurationSettingsEvents : ContentDefinitionEditorEventsBase {
        ...
        public FrontendEditorConfigurationSettingsEvents(
        ...
        private bool _typeHasConfigPart { get; set; }
        ...
        public override IEnumerable<TemplateViewModel> TypePartEditor(
            ...
            if (_typeHasConfigPart ||
                definition.ContentTypeDefinition.Parts
                    .Any(ctpd => ctpd.PartDefinition.Name == "FrontendEditConfigurationPart")) {
                _typeHasConfigPart = true;
                var settings = definition.Settings.GetModel<FrontendEditorConfigurationSettings>();
                yield return DefinitionTemplate(settings);
            }
        }
        ...
        public override void TypeEditorUpdated(ContentTypeDefinitionBuilder builder) {
            ...
            if (typeDefinition.Parts.Any(cptd => cptd.PartDefinition.Name == "FrontendEditConfigurationPart")) {
                _typeHasConfigPart = true;
        ...
        #region Methods to mess with placement
        ...
        private IEnumerable<PlacementSettings> GetEditorPlacement(
            ContentTypeDefinition definition, ContentPartDefinition partDefinition, 
            ContentPartFieldDefinition fieldDefinition, bool showEditor) {
        ...
        /// <param name="context">The context for the drivers.</param>
        /// <returns></returns>
        private Dictionary<IContentFieldDriver, IEnumerable<DriverResult>> GetFieldDriversResults(
