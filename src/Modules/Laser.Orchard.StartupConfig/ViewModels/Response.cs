...
namespace Laser.Orchard.StartupConfig.ViewModels {
    ...
    /// </summary>
    public enum ErrorCode { NoError = 0, GenericError = 1, InvalidUser = 1000, InvalidXSRF = 1001, UnAuthorized = 1002, ToConfirmEmail = 1003, ExpiredPassword = 1004, Validation = 2000, MissingPolicies = 3000, MissingParameters = 4000 }

    /// <summary>
    /// per user enum range 1000
    /// </summary>
    public enum ResolutionAction { NoAction = 0, Login = 1000, ToConfirmEmail = 1003, ToChangeExpiredPassword = 1004, AcceptPolicies = 3000, AddParameter = 4000 }
